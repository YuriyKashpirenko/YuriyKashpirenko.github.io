...
//    alert("Please enter your first name");
    document.getElementById('error_fn').innerHTML = 'Veuillez saisir votre prénom'; 
    return false;
  }
...
//    alert("Please enter your last name");
      document.getElementById('error_ln').innerHTML = 'Veuillez saisir votre nom de famille'; 
    return false;
  }    
...
//      alert("Please enter valid email address");
    document.getElementById('error_email').innerHTML = 'Veuillez saisir une adresse e-mail valide'; 
      return false;
  }  
...
//    alert("Please enter your phone, 10 digits");
    document.getElementById('error_phone').innerHTML = 'Veuillez saisir le numéro de téléphone de contact, 10 chiffres';
    return false;
  } 
...
//    alert("Please enter your car make");
    document.getElementById('error_car').innerHTML = 'S’il vous plaît entrer votre voiture faire';
    return false;
  }
...
//    alert("Please enter your car model");
    document.getElementById('error_model').innerHTML = 'Veuillez saisir votre modèle de voiture';
    return false;
  }   
...
//    alert("Please enter car year, 4 digits");
    document.getElementById('error_year').innerHTML = 'Veuillez saisir l’année de la voiture, 4 chiffres';
    return false;
  }    
...
//    alert("Please enter subject of your message");
    document.getElementById('error_subject').innerHTML = 'Veuillez saisir l’objet de votre message';
    return false;
  } 
...
//    alert("Please enter your message");
    document.getElementById('error_message').innerHTML = 'Veuillez saisir votre message';
    return false;
  }  
